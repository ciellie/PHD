...
#Net een lyn grafiek
 ...
 ggplot(kpoint_bulk, aes(x=Point,y=E ))+geom_point(size=3)+geom_line()+labs(title = "Energy per K-point", x = "Kpoint", y = "Energy") + theme_bw()
 ...
 * For each plane the following characteristics will be determined [@xrd1][@mcm41-1]
